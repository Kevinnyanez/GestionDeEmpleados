...
-- -------------------- HACEMOS INSERT A LA TABLA ADMIN CON LOS DATOS PARA EL LOGIN ---------------------------------
insert into Admins (NombreUsuario, Contraseña) 
values ('Matias' , '2025');


-- -------------------- HACEMOS INSERTS A LA TABLA EMPLEADOS ---------------------------------
...
-- -------------------- HACEMOS INSERTS A LA TABLA CATEGORIAS ---------------------------------
...
-- -------------------- HACEMOS INSERTS A LA TABLA SUBCATEGORIAS ---------------------------------
...
-- -------------------- HACEMOS INSERTS A LA TABLA PRODUCTOS ---------------------------------
